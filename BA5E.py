def global_alignment(str1, str2, indel_penalty=5):
    ...
    while i != 0 or j != 0:
        ...
        if direction == "diag":
            novi_str1 = str1[i] + novi_str1
            novi_str2 = str2[j] + novi_str2
            i -= 1
            j -= 1
        elif direction == "down":
            novi_str1 = str1[i] + novi_str1
    ...
    return score_mat[len(str1) - 1][len(str2) - 1], novi_str1, novi_str2


if __name__=="__main__":
    with open("../Downloads/rosalind_ba5e.txt","r") as f:
    ...
    broj,str1,str2=global_alignment(string1, string2, indel_penalty=5)
    print(broj)
    print(str1)
    print(str2)
